...
import { CheckboxBoxButtonsComponent } from './checkbox-buttons.component'
import checkboxesEditFormJson from '../../assets/radio-buttons.edit.json'

function checkboxesEditForm() {
...
const COMPONENT_OPTIONS: FormioCustomComponentInfo = {
  ...
  title: 'Multi Checkbox Buttons', // Title of the component
  group: 'basic', // Build Group
  icon: 'check-circle', // Icon
  fieldOptions: ['label', 'values', 'key', 'hidden', 'buttonStyle', 'inline'],
  editForm: checkboxesEditForm, // Use editForm from Radio buttons
...
export function registerCheckboxButtonsComponent(injector: Injector) {
  registerCustomFormioComponent(COMPONENT_OPTIONS, CheckboxBoxButtonsComponent, injector)
}
